// app/talent-requests/new/page.tsx  (SERVER)
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Post a Talent Request</h1>
            <p className="mt-4 text-lg text-gray-600">
              Describe your L&amp;D project or position and connect with qualified professionals who have the skills you need.
            </p>
          </div>
          <div className="mt-10">
